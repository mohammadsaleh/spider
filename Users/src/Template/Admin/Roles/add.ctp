...
<div class="page-content">
    ...
    <li>
        <span><?= __d('users', 'Add New Roles') ?></span>
    </li>
</ul>    </div>
    <div class="row">
        <div class="col-md-12">
                        ...
                        <div class="portlet box blue-hoki">
                            ...
                            <div class="portlet-body form">
                                ...
                                <div class="form-body">
                                        ...
                                        <div class="form-group">
                                            <?php
                                            echo $this->Form->label(__d('users', 'lft'), null, [
                                                'class' => 'col-md-3 control-label'
                                            ]);
                                            ?>
                                            <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                            <?php
                                            echo $this->Form->label(__d('users', 'rght'), null, [
                                                'class' => 'col-md-3 control-label'
                                            ]);
                                            ?>
                                            <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <?php
                                                echo $this->Form->input('capabilities._ids', [
